...
import 'package:movies_app/Features/explore_page/data/cubit/explore_category_movies_cubit/category_movies_state.dart';
...
import 'package:movies_app/Features/explore_page/presentation/views/widgets/category_item.dart';
import 'package:movies_app/core/utils/widgets/image_list_movies.dart';

class BodyOfCategoryTap extends StatefulWidget {
  const BodyOfCategoryTap({super.key});

  @override
  State<BodyOfCategoryTap> createState() => _BodyOfCategoryTapState();
}

class _BodyOfCategoryTapState extends State<BodyOfCategoryTap> {
